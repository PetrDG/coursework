...
class VK:
    ...
    def likes_log(self):
        ...
        result = {}
        for l in range(photo_count):
            likes_count = photo_items[l]['likes']['count']
            url_dl, photo_size = dpi_max(photo_items[l]['sizes'])
            time_load = date(photo_items[l]['date'])
...
yad_folder = YAD('VK photo', '')
yad_folder.copy_photo(json_VK.export_dict)